...
<div class="container">
    <div class="card card-success">
        ...
        <h3 class="card-title">Update Custom Category</h3>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        {!! Form::text('name',$customPost->name,['class' => 'form-control','required']) !!}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    @if($customPost->icon != null)
                    <div class="col-sm-6" id="preview"><img src="@if(App\Models\StorageSetting::getStorageSetting('storage') == 'DigitalOcean'){{\Storage::disk('spaces')->url('uploads/'.$customePost->icon)}} @else {{asset('uploads/'.$customPost->icon)}} @endif" alt="Image" class="shadow bg-white rounded" width="auto" height="120px"></div>
                    @endif
                </div>
            </div>
        </div>
