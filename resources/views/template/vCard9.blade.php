...
<head>
    ...
    <title>Business Card 9</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css"/>
    <link href="{{asset('assets/template/card5/template9.css')}}" rel="stylesheet">
...
<body>
    <div class="main-wrapper" id="home">
        <div class="firstpagetop">
            ...
            <div class="companylogo"><img src="demo-templates/images/virtual-business-card-logo.png" class="img-responsive" alt=""></div> -->
            <div class="profile">
                <div class="profilepic">
                    <img src="{{$image}}" class="img-responsive" alt="{{$name}}">
                </div>
                <div class="companyname bottomborder">{{$comapany_name}}</div>
                <div class="name">
                    {{$name}} <br>
