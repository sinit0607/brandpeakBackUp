  ...
  <div class="col-md-12">
    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <a href="{{ route('business-category.create')}}" class="btn btn-success float-right">Add New</a>
        </div> 
            ...
            <tr>
              ...
              <td class="align-middle">
                <div class="btn-group text-center">
                    <a href="{{url('admin/business-category/'.$row->id.'/edit') }}"><button type="button" class="btn btn-success"><span aria-hidden="true" class="fa fa-edit"></span></button></a>
                ...
                {!! Form::open(['url' => 'admin/business-category/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]) !!}
